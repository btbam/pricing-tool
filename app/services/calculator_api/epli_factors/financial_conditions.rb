class CalculatorApi::EpliFactors::FinancialConditions < CalculatorApi::EpliFactors::Base
  def process_factor
    @factor = 1
    financial_factor = Calculator::FinancialFactor.find_by_dnb_epli(company.financial_stress_score) if company
